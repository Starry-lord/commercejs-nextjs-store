  ...
  return (
    <div className="d-flex">
      <div className="d-flex position-relative">
        {[1, 2, 3, 4, 5].map(index => (
          <Image key={index} src="/icon/star.svg" alt="" className="w-16 d-block" width={16} height={16}/>
        ))}
        <div
        ...
        >
          {[1, 2, 3, 4, 5].map(index => (
            <Image key={index} src="/icon/star-solid.svg" alt="" className="w-16 d-block" width={16} height={16}/>
          ))}
        </div>
      </div>
