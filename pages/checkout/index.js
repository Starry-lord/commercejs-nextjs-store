...
const billingOptions = ['Pareille à l\'adresse de livraison', 'Utiliser une adresse de facturation différente'];
...
class CheckoutPage extends Component {
  ...
  handleDiscountChange(e) {
    ...
    this.props.dispatchSetDiscountCodeInCheckout(this.props.checkout.id, this.state.discountCode)
      ...
      .catch(error => {
        alert('Désolé, ce coupon n\'a pas marché');
      });
  }
                  ...
                  <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="col-12 mb-3">
                          <label className="w-100">
                            ...
                            <Dropdown
                              ...
                              placeholder="Selectionnez une méthode de livraison"
                            >
                              {
                      ...
                      >
                        ...
                        />
                        <p>
                          Recevez des bons plans par e-mail!
                          J&apos;envoie régulièrement des coupons de réduction à 
                          mes clients 🙂
                        </p>
                      </div>
